...
#read in data
#read historical validation/observed data for loss, density, housing price, policy purchases
...
#read model forecasted data for scenario 585
...
##################################################
#For scenario ssp585, group data
